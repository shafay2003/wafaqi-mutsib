...
export const keyPersonnel = [
  ...
  },
  {
    ...
    bio: [
        ...
        "Mr. Tahir’s strong academic background, his leadership role in policy formulation and implementation at provincial and national level, hands on experience of multilateral institutions and of international diplomacy and negotiations has honed his skill as a consummate professional suited for leadership positions across diverse sectors. It has also equipped him with the ability to appreciate and synthesize cross- cutting perspectives and ideas to craft practical solutions and approaches to address complex policy challenges."
    ]
  }
];
