        ...
        <section className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <Card 
                        key={office.name}
                        onMouseEnter={() => setHighlightedRegion(office.region)}
            ...
            <div className="space-y-4">
                <h2 className="text-xl font-semibold tracking-tight">Our Locations</h2>
                <div className="w-full border rounded-lg overflow-hidden p-4 bg-secondary/30 aspect-square flex items-center justify-center">
                    <InteractiveMap highlightedRegion={highlightedRegion} />
                </div>
            </div>
        </section>
    </div>
