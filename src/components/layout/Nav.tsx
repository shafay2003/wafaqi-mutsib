...
export function Nav() {
  ...
  return (
    <Sidebar className="border-r bg-white w-72">
      <SidebarHeader className="bg-gradient-to-r from-white to-green-50/20 p-4">
        <Link href="/" className="group">
          <div className="flex items-center gap-3">
            {/* Compact Logo Design - matching admin portal style */}
            <div className="relative flex-shrink-0">
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-3 shadow-sm border border-green-200/50 group-hover:shadow-md group-hover:border-green-300 transition-all duration-200">
                <img
            ...
            {/* Compact Typography - matching admin portal */}
            <div className="flex flex-col justify-center min-w-0 flex-1">
              ...
              <div className="flex items-center gap-1 mt-0.5">
                <div className="h-0.5 w-5 bg-gradient-to-r from-green-600 to-green-400"></div>
      ...
      <SidebarFooter>
        <div className="bg-gradient-to-r from-white to-green-50/20 p-4">
